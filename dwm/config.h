...
static const char *voldowncmd[] = {"amixer", "-q",     "set", "Master",
                                   "5%-",    "unmute", NULL};
static const char *miccmd[] = {"amixer",  "-q",     "set",
                               "Capture", "toggle", NULL};

/* Backlight */
/* Add this to your sudoers file for this to work */
...
static const char *colors[][3] = {
    /*               fg         bg         border   */
    [SchemeNorm] = {col_gray1, col_purple1, col_purple1},
    [SchemeSel] = {col_gray1, col_purple1, col_purple2},
};
...
static const char *dmenucmd[] = {"dmenu_run", "-m",  dmenumon,    "-fn",
                                 dmenufont,   "-nb", col_purple1, "-nf",
                                 col_gray2,   "-sb", col_purple2, "-sf",
                                 col_gray2,   NULL};
